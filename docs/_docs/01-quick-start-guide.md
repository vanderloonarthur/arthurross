...
Minimal Mistakes has been developed as a [Gem-based theme](https://jekyllrb.com/docs/themes/) for easier use, and 100% compatible with GitHub Pages when used as a remote theme.
